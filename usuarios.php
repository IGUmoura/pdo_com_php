                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        foreach($resultados as $resultado) {
                            ...
                            echo '<tr>';
                                ...
                                echo    '<td class="d-flex flex-row justify-content-around">
                                            <a href="http://192.168.1.25/TRILHAS4/igormoura/pdo_com_php/usuario_edita.php?id=' . $resultado->cod_usuario . '" class="text-warnig"><i class="far fa-edit"></i></a>

                                            <a href="http://192.168.1.25/TRILHAS4/igormoura/pdo_com_php/alterastatus.php?id=' . $resultado->cod_usuario . '" class="text-danger"><i class="fas fa-trash-alt"></i></a>
                                        </td>';
                            echo '</tr>';
                        ...
                        ?>
                         <tr>
                            <td>
                                <a href="http://192.168.1.25/TRILHAS4/neto/pdo_com_php/novousuario.php">
                                    <i class="fas fa-plus-square"></i>
                                </a>
                            </td>
                            <td colspan="4">
                                <a href="http://192.168.1.25/TRILHAS4/neto/pdo_com_php/novousuario.php">Novo usuário</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
